...
Vibeguard is a coding standard for AI-assisted development. Point your AI tool at this repo and it will produce code that is secure, scalable, modular, and production-ready, then assess your project against 24 risk domains and surface exactly where the gaps are.
...
**Integration overlays**: Pre-mapped controls for Stripe, Auth0/Clerk, Supabase, OpenAI, and SendGrid. Each integration gets its own control set (webhook HMAC verification, idempotency, OAuth token encryption, AI rate limiting) rather than a generic rule that may or may not apply.
